...
from graph.scenarios.line_circle import LineCircleGraphParams  # Zakładana ścieżka importu
...
def random_compare_on_line_circle_scenario() -> Experiment:
    return Experiment(
        name=EXP_NAME,
        graph=LINE_CIRCLE_SETUP,
        algorithm=Algorithm(type=AlgorithmType.RANDOM, params=AlgorithmParams()),
        nodes=PATH_NODES,
        times_to_run=TIMES_TO_RUN,
    )

def greedy_compare_on_line_circle_scenario() -> Experiment:
    return Experiment(
        name=EXP_NAME,
        graph=LINE_CIRCLE_SETUP,
...
def sa_compare_on_line_circle_scenario() -> Experiment:
    return Experiment(
        name=EXP_NAME,
        graph=LINE_CIRCLE_SETUP,
        algorithm=Algorithm(
...
def ga_compare_on_line_circle_scenario() -> Experiment:
    return Experiment(
        name=EXP_NAME,
        graph=LINE_CIRCLE_SETUP,
        algorithm=Algorithm(
...
def aco_compare_on_line_circle_scenario() -> Experiment:
    return Experiment(
        name=EXP_NAME,
        graph=LINE_CIRCLE_SETUP,
        algorithm=Algorithm(
...
def a_star_compare_on_line_circle_scenario() -> Experiment:
    return Experiment(
        name=EXP_NAME,
        graph=LINE_CIRCLE_SETUP,
        algorithm=Algorithm(
...
def get_all_compare_on_line_circle_scenario() -> list[Experiment]:
    experiments = []
    experiments.append(random_compare_on_line_circle_scenario())
    experiments.append(greedy_compare_on_line_circle_scenario())
    experiments.append(sa_compare_on_line_circle_scenario())
    experiments.append(ga_compare_on_line_circle_scenario())
    experiments.append(aco_compare_on_line_circle_scenario())
    experiments.append(a_star_compare_on_line_circle_scenario())
    return experiments

if __name__ == "__main__":
    all_experiments = get_all_compare_on_line_circle_scenario()
