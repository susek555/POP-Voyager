...
def random_compare_on_gradient_scenario() -> Experiment:
    return Experiment(
        name=EXP_NAME,
        graph=GRADIENT_SETUP,
        algorithm=Algorithm(
...
def greedy_compare_on_gradient_scenario() -> Experiment:
    return Experiment(
        name=EXP_NAME,
        graph=GRADIENT_SETUP,
        algorithm=Algorithm(
...
def sa_compare_on_gradient_scenario() -> Experiment:
    return Experiment(
        name=EXP_NAME,
        graph=GRADIENT_SETUP,
        algorithm=Algorithm(
...
def ga_compare_on_gradient_scenario() -> Experiment:
    return Experiment(
        name=EXP_NAME,
        graph=GRADIENT_SETUP,
        algorithm=Algorithm(
...
def aco_compare_on_gradient_scenario() -> Experiment:
    return Experiment(
        name=EXP_NAME,
        graph=GRADIENT_SETUP,
        algorithm=Algorithm(
...
def a_star_compare_on_gradient_scenario() -> Experiment:
    return Experiment(
        name=EXP_NAME,
        graph=GRADIENT_SETUP,
        algorithm=Algorithm(
...
def get_all_compare_on_gradient_scenario() -> list[Experiment]:
    experiments = []
    experiments.append(random_compare_on_gradient_scenario())
    experiments.append(greedy_compare_on_gradient_scenario())
    experiments.append(sa_compare_on_gradient_scenario())
    experiments.append(ga_compare_on_gradient_scenario())
    experiments.append(aco_compare_on_gradient_scenario())
    experiments.append(a_star_compare_on_gradient_scenario())
    return experiments

if __name__ == "__main__":
    all_experiments = get_all_compare_on_gradient_scenario()
