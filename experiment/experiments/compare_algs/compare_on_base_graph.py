...
def random_compare_on_base_graph() -> Experiment:
    experiment_name = "compare_on_base_graph"
...
def greedy_compare_on_base_graph() -> Experiment:
    experiment_name = "compare_on_base_graph"
    experiment = Experiment(
        name=f"{experiment_name}",
        graph=Graph(
...
def sa_compare_on_base_graph() -> Experiment:
    experiment_name = "compare_on_base_graph"
    experiment = Experiment(
        name=f"{experiment_name}",
        graph=Graph(
...
def ga_compare_on_base_graph() -> Experiment:
    experiment_name = "compare_on_base_graph"
    experiment = Experiment(
        name=f"{experiment_name}",
        graph=Graph(
...
def aco_compare_on_base_graph() -> Experiment:
    experiment_name = "compare_on_base_graph"
    experiment = Experiment(
        name=f"{experiment_name}",
        graph=Graph(
...
def get_all_compare_on_base_graph() -> list[Experiment]:
    experiments = []
    experiments.append(random_compare_on_base_graph())
    experiments.append(greedy_compare_on_base_graph())
    experiments.append(sa_compare_on_base_graph())
    experiments.append(ga_compare_on_base_graph())
    experiments.append(aco_compare_on_base_graph())
    return experiments


if __name__ == "__main__":
    all_compare_experiments = get_all_compare_on_base_graph()
